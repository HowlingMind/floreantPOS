...
public class POSConstants {
	...
	public static final String PRINT_RECEIPT_WHEN_TICKET_CREATED = Messages.getString("PosMessage.173"); //$NON-NLS-1$
	...
	public static final String PRINT_TO_KITCHEN_WHEN_TICKET_CREATED = Messages.getString("PosMessage.190"); //$NON-NLS-1$
